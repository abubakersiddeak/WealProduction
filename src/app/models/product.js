...
const productSchema = new Schema(
  {
    ...
    brand: { type: String },
    sizes: {
      type: [sizeSchema], // Changed back to array of sizeSchema
      default: [{ size: "Regular Size", quantity: 0 }], // Default value if no sizes are provided
    },

    inStock: { type: Boolean, default: true },
    // Removed top-level quantity field
